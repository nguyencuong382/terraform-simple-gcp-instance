...
output "vm_ids" {
  ...
  value       = "${concat(azurerm_virtual_machine.bastion_vm.*.id)}"
}
...
output "network_interface_ids" {
  ...
  value       = "${concat(azurerm_network_interface.bastion_nic.*.id)}"
}
...
output "private_ip_addresses" {
  ...
  value       = "${concat(azurerm_network_interface.bastion_nic.*.private_ip_address)}"
}